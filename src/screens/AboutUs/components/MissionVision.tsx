        ...
        <div className="row">
          <div className="col-12">
            <div className="section-title text-center">
              <h3 style={{fontFamily:'Raleway',fontWeight:'bolder',letterSpacing:1.3,fontSize:'36px'}}>About Devalsari</h3>
              <h2>
        ...
        <div className="row align-items-center">
          <div className="col-lg-6">
            <div className="video-area style--two mb-50 mb-lg-0">
              <img
                src="assets/img/about/community.png"
                data-rjs={2}
                alt=""
              ...
              <ul className="nav nav-tabs" role="tablist">
                ...
                <li className="nav-items">
                  <a
                    ...
                    style={{fontFamily:'Raleway',fontWeight:'bolder',letterSpacing:1.3,fontSize:'22px'}}
                  >
                    Our Vision
                  </a>
                </li>
