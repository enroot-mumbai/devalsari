...
const StoryData = [
  ...
  },
  {
    ...
    content: <><p>A deliberately and intelligently crafted rural development model had to be created - one that could understand the various nuances and layers of rural India, identify the gaps and shortcomings, and implement small interventions that would overcome the gaps.</p><p>It was decided to create this model called Global Parli with 15 villages in Parli. After the success of this model, the same would be replicated, scaled up, and institutionalized across the country. </p></>
  },
  {
    id:6,
      ...
      <div className="container">
        ...
        <div className="section-title text-justify">
              ...
              are abandoning their homes to shift to towns and urban areas abandoning traditional practices of agriculture.
               ...
               <br/>The primary reasons for “playen” are reduced returns from agriculture and livestock, lack of job opportunities in the villages, poor education and health care. 
