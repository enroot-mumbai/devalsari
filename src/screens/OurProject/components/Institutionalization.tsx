        ...
        <div className="row m-auto p-5">
          <div className="col-lg-6">
            <p>
              ...
              residential trainings, institutionalizing the Global Parli process
            ...
            <p>
              ...
              simultaneously creating an S.O.P. to implement Global Parli models
              across the country.
            </p>
            <p>
              Global Parli has already started working closely with the
